...
<main class="w-full flex-grow p-6">
    ...
    <div class="w-full mt-12">
        <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> Tabel Gambar
        </p>
        <div class="w-full">
            <div class="flex md:flex-row flex-col gap-y-3 min-w-full items-center justify-between bg-indigo-inventory p-3">
                <a class="py-1 px-3 text-white bg-blue-600 hover:bg-blue-900 transition delay-200"  href="{{ route('gambar.create') }}">
                    Tambah
                </a>
            </div>
        </div>
                ...
                <tbody>
                    <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="flex space-x-2 py-4 px-6 border-b border-grey-light">
                            ...
                            <form action="{{ route('gambar.edit') }}" method="post">
                                <button type="submit"

    ...
    <div class="w-full mt-12">
        ...
        <div class="w-full">
            <div class="flex md:flex-row flex-col gap-y-3 min-w-full items-center justify-between bg-indigo-inventory p-3">
                <a href="{{ route('jenis-laporan.create') }}" class="py-1 px-3 text-white bg-blue-600 hover:bg-blue-900 transition delay-200"  href="#">
                    Tambah
                </a>
            </div>
        </div>
                ...
                <tbody>
                    <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="flex space-x-2 py-4 px-6 border-b border-grey-light">
                            <a href="{{ route('jenis-laporan.edit') }}">
                                <div
                            ...
                            <form action="{{ route('jenis-laporan.edit') }}" method="post">
                                <button type="submit"
